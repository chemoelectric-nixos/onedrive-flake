...
----
onedrive = {
  url = "github:chemoelectric-nixos/onedrive-flake/v1.1.5?dir=build%2Fx86_64-linux%2Frelease-25.11%2Fonedrive-2.5.9%2Fsystemd-true";
};
----

is a setting for an AMD64 GNU/Linux system with NixOS 25.11, using
